...
extern volatile rpi_pwm_t *rpi_i2c0;
extern volatile rpi_pwm_t *rpi_i2c1;
extern volatile rpi_pwm_t *rpi_i2c2;
...
int rpi_init(void)
{
    ...
    if (geteuid() == 0) {
        ...
        rpi_i2c0 = (rpi_pwm_t*)(rpi_peripherals + RPI_I2C0/4);
        rpi_i2c1 = (rpi_pwm_t*)(rpi_peripherals + RPI_I2C1/4);
        rpi_i2c2 = (rpi_pwm_t*)(rpi_peripherals + RPI_I2C2/4);
        ok = 0;
    }
    else {
